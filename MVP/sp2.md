...
|-----|-----------------------------------------------------------------------------|------------|------------|
| US1 | Como gestor público, desejo visualizar um protótipo de dashboard já alimentado com dados da base RAIS do governo, com foco no setor alimentício nos municípios de São José dos Campos e Caçapava. O objetivo é apresentar uma análise comparativa entre os diferentes CNAEs do setor, permitindo identificar padrões, variações e insights relevantes para apoiar a tomada de decisão.      | Média       | 5 pontos   |
| US2 | Como gestor público, desejo visualizar, por meio do dashboard, uma análise clara das variações de empregabilidade, tanto de crescimento, quanto de retração, no mercado de trabalho da cadeia produtiva alimentícia, permitindo identificar tendências, sazonalidades e possíveis impactos no setor.         | Alta      | 3 pontos   |
| US3 | Como gestor público, desejo visualizar, por meio do dashboard, uma análise do nível de escolaridade dos trabalhadores da cadeia produtiva alimentícia, permitindo identificar a distribuição educacional, padrões predominantes e possíveis lacunas de qualificação no setor.         | Alta      | 3 pontos   |
| US4 | Como gestor público, desejo visualizar, por meio do dashboard, uma análise da remuneração média dos trabalhadores da cadeia produtiva alimentícia, permitindo identificar a distribuição salarial, variações entre segmentos e possíveis desigualdades no setor.        | Alta      | 3 pontos   |
